...
for n in n_topics:
    ...
    parser.add_argument('--n_topics', type=int, default=40, help='number of topics')
    parser.add_argument('--alpha', type=float, default=1, help='alpha')
    parser.add_argument('--beta', type=float, default=0.0, help='beta')
    parser.add_argument('--max_err', type=float, default=15, help='stop criterion')
    ...
    tmp_folder = f'SeaNMF/seanmf_results/{n}'
